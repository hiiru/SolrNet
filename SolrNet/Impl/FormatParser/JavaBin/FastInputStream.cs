#region license
// This File is based on the FastInputStream created by the Terry Liang and the easynet Project (http://easynet.codeplex.com).
//  
...
namespace SolrNet.Impl.FormatParser.JavaBin
{
	class FastInputStream : Stream
	{
		...
		{
			return Converter.ToFloat(ReadInt());
		}
		...
		public double ReadDouble() {
			return Converter.ToDouble(ReadLong());
		}
