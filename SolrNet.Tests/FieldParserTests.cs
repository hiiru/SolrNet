...
namespace SolrNet.Tests
{
	...
	public class FieldParserTests
	{
		...
		{
			var p = new FloatFieldParser();
			var docNode = new SolrResponseDocumentNode("", SolrResponseDocumentNodeType.String) { Value = "pepe" };
		...
		public void DoubleFieldParser()
		{
			...
			var docNode = new SolrResponseDocumentNode("", SolrResponseDocumentNodeType.Float) { Value = "123.99" };
		...
		public void DecimalFieldParser()
		{
			...
			var docNode = new SolrResponseDocumentNode("", SolrResponseDocumentNodeType.Float) { Value = "6.66E13" };
		...
		{
			var p = new DecimalFieldParser();
			var docNode = new SolrResponseDocumentNode("", SolrResponseDocumentNodeType.Float) { Value = "6.66E53" };
			var value = (decimal)p.Parse(docNode, typeof(decimal));
		}
		...
		public void DefaultFieldParser_EnumAsString()
		{
			...
			var docNode = new SolrResponseDocumentNode("", SolrResponseDocumentNodeType.String) { Value = "One" };
		...
		public void SupportGuid()
		{
			var p = new DefaultFieldParser();
			var g = Guid.NewGuid();
			var docNode = new SolrResponseDocumentNode("", SolrResponseDocumentNodeType.String) { Value = g.ToString() };
